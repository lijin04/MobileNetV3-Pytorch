...
def load_data(args):
    if args.dataset_mode == "CIFAR100":
        ...
        train_loader = torch.utils.data.DataLoader(
            datasets.CIFAR100('data/cifar', train=True, download=False, transform=transform_train),
        ...
        train_loader = torch.utils.data.DataLoader(
            datasets.CIFAR10('data/cifar', train=True, download=False, transform=transform_train),
            batch_size=args.batch_size,
            shuffle=True,
            num_workers=args.workers
        )
